...
export class ProjectsComponent {
  projects: Project[] = [
    new Project(
      ...
      [
        'https://github.com/almarpa/KMMTemplateApp/blob/develop/composeApp/src/main/snapshots/Detail.png?raw=true',
        'https://github.com/almarpa/KMMTemplateApp/blob/develop/composeApp/src/main/snapshots/Home.png?raw=true',
        'https://github.com/almarpa/KMMTemplateApp/blob/develop/composeApp/src/main/snapshots/Search.png?raw=true',
        'https://github.com/almarpa/KMMTemplateApp/blob/develop/composeApp/src/main/snapshots/Team.png?raw=true',
        'https://github.com/almarpa/KMMTemplateApp/blob/develop/composeApp/src/main/snapshots/NewMember.png?raw=true',
        'https://github.com/almarpa/KMMTemplateApp/blob/develop/composeApp/src/main/snapshots/Drawer.png?raw=true',
        'https://github.com/almarpa/KMMTemplateApp/blob/develop/composeApp/src/main/snapshots/Settings.png?raw=true',
        'https://github.com/almarpa/KMMTemplateApp/blob/develop/composeApp/src/main/snapshots/Landscape.png?raw=true',
      ],
